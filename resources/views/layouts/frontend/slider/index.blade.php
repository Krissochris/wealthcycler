                ...
                <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-1000" data-transition="slidingoverlayhorizontal"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('assets/images/main-slider/slider2/slide1.jpg') }}" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme"
                                ...
                                <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;">
                                    <span class="text-white" style="padding-right:10px;">SOCIAL ENGAGEMENTS </span>
                                </div>
                            ...
                            <div class="tp-caption   tp-resizeme"
                                ...
                                <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                            <span class="text-primary"
                                                  style="padding-right:10px;"> Sports & </span><span
                                        class="text-primary"> Pageantry</span>
                                </div>
                            </div>
                                 ...
                                 style="z-index: 13;
                                    ...
                                    border-width:0px;">
                                        <span style="font-family: 'Poppins', sans-serif;">
                                            Here in TYEN CLUB, its all about Sports, Pageantry, Inter-engagement Competitions
                                        </span>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                ...
                                <a href="{{ route('register') }}" class="site-button slider-btn-left">Register</a>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index:13;
                                    ...
                                    font-weight:500;
                                    ">
                                <a href="{{ route('login') }}" class=" site-button white slider-btn-right">Login</a>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 13;">
                                <img src="{{ asset('assets/images/main-slider/slider2/earth.png') }}" alt="" class="spin-city">
                            </div>
                        ...
                        <li data-index="rs-1001" data-transition="slidingoverlayhorizontal"
                            ...
                            <div class="tp-caption   tp-resizeme"
                                ...
                                <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                    <span class="text-white" style="padding-right:10px;"> YOUTH EMPOWERMENT </span><br>
                                    <span class="text-primary">Idea funding</span>
                                </div>
                            ...
                            <div class="tp-caption  tp-resizeme"
                                 ...
                                 style="z-index: 13;
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                <span style="font-family: 'Poppins', sans-serif;"> We make our members ideas a reality ...</span>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 13;">
                                <img src="{{ asset('assets/images/main-slider/slider2/earth2.png') }}" alt="" class="spin-city">
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 13;">
                                <img src="{{ asset('assets/images/main-slider/slider2/earth2-shadow.png') }}" alt="">
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                ...
                                <div class="coin-slide bg-full-width bg-repeat-y coin-slide-rotate"
                                     style="background-image:url({{ asset('assets/images/main-slider/slider2/coin-sky.png') }});height:100vh;"></div>
                            </div>
                        ...
                        <li data-index="rs-1002" data-transition="slidingoverlayhorizontal"
                            ...
                            <div class="tp-caption   tp-resizeme"
                                ...
                                <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                    <span class="text-primary">AUTOMATED VFS</span> <br>
                                    <span class="text-white">Compounding Savings</span>
                                </div>
                            ...
                            <div class="tp-caption  tp-resizeme"
                                 ...
                                 style="z-index: 13;
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                <span style="font-family: 'Poppins', sans-serif;">With our robust virtual finance system, we compound savings for every member of our club without member tasked to do anything!
                                BE PART OF TODAY'S FUTURE!
                                </span>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 13;">
                                <img src="{{ asset('assets/images/main-slider/slider2/rock.png') }}" alt="">
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 13;">
                                <img src="{{ asset('assets/images/main-slider/slider2/agent.png') }}" alt="">
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 13;">
                                <img src="{{ asset('assets/images/main-slider/slider2/plant.png') }}" alt="">
                            </div>
                        </li>
